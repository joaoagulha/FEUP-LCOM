 ...
 *
 * Increments counter on every timer interrupt (Timer 0)
 *
 */
void timer_int_handler();

/**
 * @brief increments variable elapsed_time, on every timer interrupt
 *
 */
 ...
 *  per second for the specified time interval with duration of @param time
 *
